...
SBomber::SBomber()
    :
        ...
        score(0) 
{
    LoggerSingleton::instance().WriteToLog(std::string(__FUNCTION__) + " was invoked");
    ...
    const uint16_t maxX = LoggerSingleton::instance().GetMaxX();
    const uint16_t maxY = LoggerSingleton::instance().GetMaxY(); 
...
void SBomber::ProcessKBHit() {
    ...
    LoggerSingleton::instance().WriteToLog(std::string(__FUNCTION__) + " was invoked. key = ", c);
...
void SBomber::DrawFrame() {
    ...
    LoggerSingleton::instance().GotoXY(0, 0);
    fps++;
...
void SBomber::TimeFinish() {
    ...
    LoggerSingleton::instance().WriteToLog(std::string(__FUNCTION__) + " deltaTime = ", (int)deltaTime);
}
